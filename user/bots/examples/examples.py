...
Đây là nơi chứa bot mẫu phía user-space.

Usage::

    from user.bots.examples.examples import SMABot
    from vnstock_forecast.engine.backtest import BacktestEngine
...
class SMABot(BotBase):
    ...
    def on_step(self, ctx: StepContext) -> list[Action]:
        ...
        for symbol in ctx.symbols:
            ...
            if prev_sma != prev_sma or curr_sma != curr_sma:
                continue
