...
from vnstock_forecast.backtest.bot_base import Action, ActionType, BotBase
...
class AnalysisBot(BotBase):
    ...
    def __init__(
        ...
        Args:
            ...
            min_confidence: Ngưỡng confidence tối thiểu để chấp nhận signal.
        """
        self.name = name
    ...
    def on_step(self, ctx: StepContext) -> list[Action]:
        ...
        # 4) Ghi lại lịch sử
        self.signal_history.extend(accepted)

        # 5) Chuyển thành Actions
    ...
    def accept_signal(self, signal: Signal, ctx: StepContext) -> bool:
        ...
        - Chấp nhận nếu confidence ≥ min_confidence.
        """
